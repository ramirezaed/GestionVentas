...
Public Class productoPorCodigo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "login.productoPorCodigo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cod_producto() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedproductoPorCodigo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As productoPorCodigo = New productoPorCodigo()
        rpt.Site = Me.Site
        Return rpt
    End Function
