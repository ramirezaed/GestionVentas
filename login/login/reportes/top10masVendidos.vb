...
Public Class top10masVendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "login.top10masVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtop10masVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As top10masVendidos = New top10masVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
